...
(injected at build time from that file's `[quickstart]` region) — as part of the
normal `python-test` unittest discovery, against the
...
is exactly the code that's tested, never merely illustrative.
