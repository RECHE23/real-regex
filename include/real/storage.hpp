...
struct dynamic_storage
{
  ...
  [[nodiscard]] constexpr program_view view() const { return program.view(); }

  //! \return The original pattern text.
  [[nodiscard]] constexpr std::string_view pattern() const { return pattern_text; }

  //! \return The effective flags (constructor flags merged with (?ims)).
  [[nodiscard]] constexpr flags compiled_flags() const { return effective_flags; }
};
...
public:
  ...
  [[nodiscard]] constexpr std::string_view pattern() const { return Pat.view(); }
