...
both ISAs, on the same `75e1b8c`+anchored-row tree for this re-stamp.
...
| --- | ---: | ---: | ---: | ---: |
| words `[a-z]+` | 1.84 | 28.49 (**15.46×**) | 6.41 (**3.48×**) | 28.24 (**15.32×**) |
| digits `[0-9]+` | 1.29 | 24.07 (**18.69×**) | 3.63 (**2.82×**) | 16.86 (**13.09×**) |
| fields `[^,]+` | 6.26 | 24.72 (**3.95×**) | 4.95 (0.79×) | 23.01 (**3.67×**) |
| alternation `the\|fox\|dog` | 2.42 | 29.99 (**12.39×**) | 2.25 (0.93×) | 10.44 (**4.31×**) |
| date `{4}-{2}-{2}` | 0.69 | 18.46 (**26.83×**) | 0.61 (0.89×) | 4.09 (**5.94×**) |
| hex `[0-9a-f]{8}` | 1.35 | 20.40 (**15.14×**) | 1.96 (**1.46×**) | 4.09 (**3.04×**) |
| literal | 0.45 | 14.97 (**33.12×**) | 0.59 (**1.31×**) | 2.39 (**5.29×**) |
| anchored `^[a-z]+$` | 0.51 | unsupported | 0.52 (**1.01×**) | 1.78 (**3.46×**) |
| lookahead `[a-z]+(?=[a-z])` | 7.78 | 75.67 (**9.72×**) | 6.77 (0.87×) | unsupported |

**arm64** — Apple M1 Pro, Apple clang 16, N = 30 × 3 runs, PCRE2 10.47-JIT, RE2 11.0:

| case | REAL ns/B | std::regex | PCRE2-JIT | RE2 |
| --- | ---: | ---: | ---: | ---: |
| words `[a-z]+` | 1.16 | 93.74 (**80.60×**) | 2.33 (**2.00×**) | 13.94 (**11.99×**) |
| digits `[0-9]+` | 0.85 | 83.79 (**99.04×**) | 1.45 (**1.71×**) | 8.65 (**10.22×**) |
| fields `[^,]+` | 3.27 | 76.16 (**23.31×**) | 1.87 (0.57×) | 11.07 (**3.39×**) |
| alternation `the\|fox\|dog` | 2.08 | 112.20 (**53.84×**) | 1.57 (0.75×) | 6.17 (**2.96×**) |
| date `{4}-{2}-{2}` | 0.48 | 72.98 (**151.41×**) | 0.39 (0.81×) | 3.43 (**7.12×**) |
| hex `[0-9a-f]{8}` | 1.42 | 80.79 (**56.81×**) | 1.25 (0.88×) | 3.41 (**2.40×**) |
| literal | 0.25 | 30.96 (**125.34×**) | 0.48 (**1.94×**) | 1.36 (**5.51×**) |
| anchored `^[a-z]+$` | 0.32 | unsupported | 0.42 (**1.32×**) | 2.21 (**6.93×**) |
| lookahead `[a-z]+(?=[a-z])` | 3.82 | 159.53 (**41.74×**) | 3.66 (0.96×) | unsupported |
