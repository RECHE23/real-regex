...
both ISAs, on the same `f95d4a3` tree for this re-stamp.
...
| --- | ---: | ---: | ---: | ---: |
| words `[a-z]+` | 1.72 | 29.75 (**17.34×**) | 6.46 (**3.76×**) | 28.24 (**16.46×**) |
| digits `[0-9]+` | 1.21 | 24.68 (**20.40×**) | 3.63 (**3.00×**) | 16.78 (**13.87×**) |
| fields `[^,]+` | 6.32 | 25.28 (**4.00×**) | 4.93 (0.78×) | 22.98 (**3.63×**) |
| alternation `the\|fox\|dog` | 2.45 | 30.62 (**12.49×**) | 2.26 (0.92×) | 10.44 (**4.26×**) |
| date `{4}-{2}-{2}` | 0.70 | 18.56 (**26.51×**) | 0.61 (0.87×) | 4.08 (**5.83×**) |
| hex `[0-9a-f]{8}` | 1.35 | 20.83 (**15.43×**) | 1.90 (**1.41×**) | 4.08 (**3.02×**) |
| literal | 0.45 | 15.12 (**33.60×**) | 0.59 (**1.31×**) | 2.38 (**5.29×**) |
| anchored `^[a-z]+$` | 0.51 | unsupported | 0.52 (**1.01×**) | 1.78 (**3.46×**) |
| lookahead `[a-z]+(?=[a-z])` | 7.52 | 76.66 (**10.19×**) | 6.78 (0.90×) | unsupported |

**arm64** — Apple M1 Pro, Apple clang 16, N = 30 × 3 runs, PCRE2 10.47-JIT, RE2 11.0:

| case | REAL ns/B | std::regex | PCRE2-JIT | RE2 |
| --- | ---: | ---: | ---: | ---: |
| words `[a-z]+` | 1.18 | 93.20 (**79.18×**) | 2.32 (**1.97×**) | 14.14 (**12.01×**) |
| digits `[0-9]+` | 0.84 | 83.19 (**98.45×**) | 1.44 (**1.70×**) | 8.76 (**10.37×**) |
| fields `[^,]+` | 3.30 | 75.75 (**22.97×**) | 1.88 (0.57×) | 11.09 (**3.36×**) |
| alternation `the\|fox\|dog` | 1.99 | 116.11 (**58.46×**) | 1.56 (0.79×) | 6.19 (**3.12×**) |
| date `{4}-{2}-{2}` | 0.48 | 72.18 (**149.75×**) | 0.39 (0.81×) | 3.43 (**7.12×**) |
| hex `[0-9a-f]{8}` | 1.43 | 79.62 (**55.76×**) | 1.25 (0.88×) | 3.41 (**2.39×**) |
| literal | 0.25 | 31.09 (**125.36×**) | 0.48 (**1.94×**) | 1.36 (**5.48×**) |
| anchored `^[a-z]+$` | 0.32 | unsupported | 0.43 (**1.35×**) | 2.19 (**6.87×**) |
| lookahead `[a-z]+(?=[a-z])` | 3.84 | 158.34 (**41.28×**) | 3.71 (0.97×) | unsupported |
