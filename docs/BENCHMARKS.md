...
both ISAs, on the same `4d5bbe5` (v2026.8.3) tree for this re-stamp.
...
one x86-64 row spreads past 3 % across the runs — `date` 0.726 / 0.679 / 0.677; every other row holds inside 1 % (`words` 2.871–2.881, `fields` 6.011–6.042, `lookahead` 7.495–7.537), which is tighter than any previous stamp of this table. The PCRE2
...
| --- | ---: | ---: | ---: | ---: |
| words `[a-z]+` | 2.87 | 28.84 (**10.05×**) | 6.41 (**2.23×**) | 28.36 (**9.88×**) |
| digits `[0-9]+` | 1.79 | 24.61 (**13.75×**) | 3.63 (**2.03×**) | 16.89 (**9.44×**) |
| fields `[^,]+` | 6.01 | 24.87 (**4.14×**) | 5.00 (0.83×) | 22.87 (**3.80×**) |
| alternation `the\|fox\|dog` | 2.33 | 29.88 (**12.82×**) | 2.26 (0.97×) | 10.48 (**4.50×**) |
| date `{4}-{2}-{2}` | 0.68 | 18.64 (**27.53×**) | 0.61 (0.90×) | 4.10 (**6.06×**) |
| hex `[0-9a-f]{8}` | 1.35 | 20.55 (**15.27×**) | 1.92 (**1.43×**) | 4.10 (**3.05×**) |
| literal | 0.42 | 15.76 (**37.61×**) | 0.59 (**1.41×**) | 2.38 (**5.68×**) |
| lookahead `[a-z]+(?=[a-z])` | 7.50 | 75.14 (**10.03×**) | 6.77 (0.90×) | unsupported |

**arm64** — Apple M1 Pro, Apple clang 16, N = 30 × 3 runs, PCRE2 10.47-JIT, RE2 11.0:

| case | REAL ns/B | std::regex | PCRE2-JIT | RE2 |
| --- | ---: | ---: | ---: | ---: |
| words `[a-z]+` | 2.21 | 90.80 (**40.99×**) | 2.32 (**1.05×**) | 13.92 (**6.28×**) |
| digits `[0-9]+` | 1.38 | 81.53 (**59.04×**) | 1.44 (**1.04×**) | 8.44 (**6.11×**) |
| fields `[^,]+` | 3.15 | 74.73 (**23.72×**) | 1.87 (0.59×) | 10.97 (**3.48×**) |
| alternation `the\|fox\|dog` | 1.92 | 112.81 (**58.82×**) | 1.57 (0.82×) | 6.14 (**3.20×**) |
| date `{4}-{2}-{2}` | 0.51 | 71.88 (**140.12×**) | 0.39 (0.76×) | 3.40 (**6.63×**) |
| hex `[0-9a-f]{8}` | 1.42 | 79.92 (**56.12×**) | 1.24 (0.87×) | 3.40 (**2.39×**) |
| literal | 0.25 | 30.87 (**124.98×**) | 0.48 (**1.94×**) | 1.36 (**5.51×**) |
| lookahead `[a-z]+(?=[a-z])` | 3.75 | 156.56 (**41.74×**) | 3.65 (0.97×) | unsupported |
...
| --- | ---: | ---: | ---: | ---: | --- |
| `\w+` (mixed-script) | 3.017 | 60.48 (20.05×) | 1.86 (**0.62×**) | 3.19 (1.06×) | 16218/5406/16218/5406 ⚠ |
| `\p{L}+` (CJK) | 3.999 | unsupported | 1.33 (**0.33×**) | 13.13 (3.28×) | 12904/—/12904/12904 |
| `\p{N}+` (arabic digits) | 2.107 | unsupported | 1.61 (**0.76×**) | 5.21 (2.47×) | 6250/—/6250/6250 |
| `\p{sc=Han}` (CJK) | 5.621 | unsupported | 2.14 (**0.38×**) | unsupported | 25808/—/25808/— |
| `\p{scx=Cyrl}` (mixed-script) | 4.171 | unsupported | 2.69 (**0.64×**) | unsupported | 32436/—/32436/— |
| `(?i)café` (accented) | 1.292 | unsupported | 0.34 (**0.26×**) | 1.31 (1.01×) | 3509/—/3509/3509 |
| `[à-ÿ]+` (accented) | 3.390 | 88.23 (26.03×) | 2.05 (**0.60×**) | 12.57 (3.71×) | 38599/38599/38599/38599 |
| literal `你好` (CJK) | 0.457 | 28.87 (63.17×) | 0.58 (**1.27×**) | 2.62 (5.73×) | 6452/6452/6452/6452 |
| `.` (emoji, one codepoint) | 4.353 | 58.71 (13.49×) | 3.88 (**0.89×**) | 18.87 (4.33×) | 68306/200039/68306/68306 ⚠ |
| ascii witness `[a-z]+` | 2.215 | 90.97 (41.07×) | 2.25 (**1.02×**) | 13.73 (6.20×) | 42108/42108/42108/42108 |
