...
| --- | ---: | ---: | ---: | ---: |
| words `[a-z]+` | 1.56 | 28.72 (**18.40×**) | 6.44 (**4.13×**) | 28.22 (**18.08×**) |
| digits `[0-9]+` | 1.04 | 24.65 (**23.61×**) | 3.63 (**3.48×**) | 16.76 (**16.05×**) |
| fields `[^,]+` | 2.99 | 25.03 (**8.38×**) | 4.94 (**1.65×**) | 22.95 (**7.68×**) |
| single `[a-z]` | 5.09 | 65.00 (**12.76×**) | 23.79 (**4.67×**) | 90.64 (**17.79×**) |
| alternation `the\|fox\|dog` | 2.41 | 29.66 (**12.30×**) | 2.26 (0.94×) | 10.42 (**4.32×**) |
| date `{4}-{2}-{2}` | 0.69 | 18.50 (**26.77×**) | 0.62 (0.90×) | 4.09 (**5.92×**) |
| hex `[0-9a-f]{8}` | 1.37 | 20.93 (**15.28×**) | 1.89 (**1.38×**) | 4.09 (**2.99×**) |
| literal | 0.43 | 15.01 (**35.07×**) | 0.59 (**1.38×**) | 2.39 (**5.58×**) |
| anchored `^[a-z]+$` | 0.52 | unsupported | 0.52 (**1.01×**) | 1.78 (**3.46×**) |
| lookahead `[a-z]+(?=[a-z])` | 7.59 | 75.71 (**9.97×**) | 6.79 (0.89×) | unsupported |

**arm64** — Apple M1 Pro, Apple clang 16, N = 30 × 3 runs, PCRE2 10.47-JIT, RE2 11.0:

| case | REAL ns/B | std::regex | PCRE2-JIT | RE2 |
| --- | ---: | ---: | ---: | ---: |
| words `[a-z]+` | 1.16 | 93.19 (**80.13×**) | 2.33 (**2.00×**) | 14.08 (**12.11×**) |
| digits `[0-9]+` | 0.85 | 82.42 (**97.42×**) | 1.44 (**1.70×**) | 8.59 (**10.15×**) |
| fields `[^,]+` | 2.22 | 75.73 (**34.10×**) | 1.88 (0.85×) | 11.04 (**4.97×**) |
| single `[a-z]` | 4.21 | 66.67 (**15.83×**) | 8.09 (**1.92×**) | 41.42 (**9.83×**) |
| alternation `the\|fox\|dog` | 2.00 | 114.93 (**57.44×**) | 1.57 (0.78×) | 6.02 (**3.01×**) |
| date `{4}-{2}-{2}` | 0.49 | 72.64 (**147.64×**) | 0.39 (0.79×) | 3.40 (**6.91×**) |
| hex `[0-9a-f]{8}` | 1.42 | 80.43 (**56.76×**) | 1.24 (0.88×) | 3.40 (**2.40×**) |
| literal | 0.25 | 30.84 (**122.38×**) | 0.48 (**1.90×**) | 1.35 (**5.36×**) |
| anchored `^[a-z]+$` | 0.32 | unsupported | 0.42 (**1.32×**) | 2.18 (**6.83×**) |
| lookahead `[a-z]+(?=[a-z])` | 3.81 | 158.32 (**41.53×**) | 3.67 (0.96×) | unsupported |
...
| --- | ---: | ---: | ---: | ---: | --- |
| `\w+` (mixed-script) | 1.970 | 60.37 (**30.64×**) | 1.86 (0.94×) | 3.20 (**1.62×**) | 16218/5406/16218/5406 ⚠ |
| `\p{L}+` (CJK) | 2.007 | unsupported | 1.34 (0.67×) | 13.28 (**6.62×**) | 12904/—/12904/12904 |
| `\p{N}+` (arabic digits) | 1.880 | unsupported | 1.61 (0.86×) | 5.20 (**2.77×**) | 6250/—/6250/6250 |
| `\p{sc=Han}` (CJK) | 2.312 | unsupported | 2.15 (0.93×) | unsupported | 25808/—/25808/— |
| `\p{scx=Cyrl}` (mixed-script) | 2.743 | unsupported | 2.69 (0.98×) | unsupported | 32436/—/32436/— |
| `(?i)café` (accented) | 0.410 | unsupported | 0.34 (0.83×) | 1.31 (**3.20×**) | 3509/—/3509/3509 |
| `[à-ÿ]+` (accented) | 1.617 | 87.82 (**54.31×**) | 2.06 (**1.27×**) | 12.58 (**7.78×**) | 38599/38599/38599/38599 |
| literal `你好` (CJK) | 0.467 | 29.18 (**62.48×**) | 0.58 (**1.24×**) | 2.63 (**5.63×**) | 6452/6452/6452/6452 |
| `.` (emoji, one codepoint) | 2.160 | 59.27 (**27.44×**) | 3.81 (**1.76×**) | 19.00 (**8.80×**) | 68306/200039/68306/68306 ⚠ |
| ascii witness `[a-z]+` | 1.164 | 92.10 (**79.12×**) | 2.26 (**1.94×**) | 13.83 (**11.88×**) | 42108/42108/42108/42108 |
