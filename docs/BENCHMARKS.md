...
| Python | CPython 3.14.6, `re` (stdlib) vs the in-place REAL `2026.8.12` extension (§B re-measured at this stamp over three passes; five of the six headline rows read within 2 % of the previous stamp on ALL THREE, including one taken under a background load of 14 — see §B for the sixth) |
