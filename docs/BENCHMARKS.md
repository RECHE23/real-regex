...
| --- | ---: | ---: | ---: | ---: |
| words `[a-z]+` | 1.73 | 29.70 (**17.17×**) | 6.44 (**3.72×**) | 28.19 (**16.29×**) |
| digits `[0-9]+` | 1.13 | 24.93 (**22.06×**) | 3.64 (**3.22×**) | 16.76 (**14.83×**) |
| fields `[^,]+` | 2.91 | 25.48 (**8.76×**) | 4.94 (**1.70×**) | 22.93 (**7.88×**) |
| alternation `the\|fox\|dog` | 2.43 | 30.57 (**12.58×**) | 2.25 (0.93×) | 10.39 (**4.28×**) |
| date `{4}-{2}-{2}` | 0.74 | 18.75 (**25.34×**) | 0.61 (0.82×) | 4.10 (**5.54×**) |
| hex `[0-9a-f]{8}` | 1.37 | 21.36 (**15.59×**) | 1.91 (**1.39×**) | 4.08 (**2.98×**) |
| literal | 0.44 | 15.17 (**34.48×**) | 0.59 (**1.34×**) | 2.38 (**5.41×**) |
| anchored `^[a-z]+$` | 0.52 | unsupported | 0.52 (1.00×) | 1.78 (**3.42×**) |
| lookahead `[a-z]+(?=[a-z])` | 7.72 | 76.68 (**9.93×**) | 6.79 (0.88×) | unsupported |

**arm64** — Apple M1 Pro, Apple clang 16, N = 30 × 3 runs, PCRE2 10.47-JIT, RE2 11.0:

| case | REAL ns/B | std::regex | PCRE2-JIT | RE2 |
| --- | ---: | ---: | ---: | ---: |
| words `[a-z]+` | 1.27 | 94.43 (**74.35×**) | 2.40 (**1.89×**) | 14.38 (**11.32×**) |
| digits `[0-9]+` | 0.97 | 84.64 (**87.26×**) | 1.48 (**1.53×**) | 8.90 (**9.18×**) |
| fields `[^,]+` | 2.35 | 76.75 (**32.66×**) | 1.92 (0.82×) | 11.35 (**4.83×**) |
| alternation `the\|fox\|dog` | 1.99 | 115.83 (**58.21×**) | 1.57 (0.79×) | 6.29 (**3.16×**) |
| date `{4}-{2}-{2}` | 0.49 | 74.08 (**151.18×**) | 0.39 (0.80×) | 3.52 (**7.18×**) |
| hex `[0-9a-f]{8}` | 1.42 | 82.57 (**58.15×**) | 1.24 (0.87×) | 3.49 (**2.46×**) |
| literal | 0.25 | 31.94 (**127.76×**) | 0.50 (**2.00×**) | 1.36 (**5.44×**) |
| anchored `^[a-z]+$` | 0.32 | unsupported | 0.42 (**1.31×**) | 2.20 (**6.88×**) |
| lookahead `[a-z]+(?=[a-z])` | 3.83 | 161.26 (**42.10×**) | 3.68 (0.96×) | unsupported |
...
| `\w+` (mixed-script) | 2.239 | 61.82 (**27.61×**) | 1.92 (0.86×) | 3.29 (**1.47×**) | 16218/5406/16218/5406 ⚠ |
| `\p{L}+` (CJK) | 2.094 | unsupported | 1.37 (0.65×) | 13.64 (**6.51×**) | 12904/—/12904/12904 |
| `\p{N}+` (arabic digits) | 1.944 | unsupported | 1.66 (0.85×) | 5.36 (**2.76×**) | 6250/—/6250/6250 |
| `\p{sc=Han}` (CJK) | 2.508 | unsupported | 2.21 (0.88×) | unsupported | 25808/—/25808/— |
| `\p{scx=Cyrl}` (mixed-script) | 2.772 | unsupported | 2.72 (0.98×) | unsupported | 32436/—/32436/— |
| `(?i)café` (accented) | 0.417 | unsupported | 0.36 (0.86×) | 1.35 (**3.24×**) | 3509/—/3509/3509 |
| `[à-ÿ]+` (accented) | 1.709 | 89.69 (**52.48×**) | 2.12 (**1.24×**) | 12.99 (**7.60×**) | 38599/38599/38599/38599 |
| literal `你好` (CJK) | 0.471 | 30.02 (**63.74×**) | 0.59 (**1.25×**) | 2.69 (**5.71×**) | 6452/6452/6452/6452 |
| `.` (emoji, one codepoint) | 2.222 | 60.09 (**27.04×**) | 3.90 (**1.76×**) | 19.53 (**8.79×**) | 68306/200039/68306/68306 ⚠ |
| ascii witness `[a-z]+` | 1.267 | 93.86 (**74.08×**) | 2.25 (**1.78×**) | 14.29 (**11.28×**) | 42108/42108/42108/42108 |
