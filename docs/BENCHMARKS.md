...
both ISAs, on the same `4da8472` (v2026.8.3+) tree for this re-stamp.
...
| --- | ---: | ---: | ---: | ---: |
| words `[a-z]+` | 1.71 | 29.32 (**17.17×**) | 6.42 (**3.76×**) | 28.34 (**16.59×**) |
| digits `[0-9]+` | 1.09 | 25.04 (**22.99×**) | 3.63 (**3.33×**) | 16.83 (**15.45×**) |
| fields `[^,]+` | 6.46 | 25.04 (**3.88×**) | 4.93 (0.76×) | 22.98 (**3.56×**) |
| alternation `the\|fox\|dog` | 2.28 | 30.11 (**13.21×**) | 2.27 (1.00×) | 10.50 (**4.61×**) |
| date `{4}-{2}-{2}` | 0.70 | 18.78 (**26.79×**) | 0.61 (0.87×) | 4.10 (**5.85×**) |
| hex `[0-9a-f]{8}` | 1.35 | 21.44 (**15.86×**) | 1.96 (**1.45×**) | 4.09 (**3.03×**) |
| literal | 0.43 | 15.20 (**35.51×**) | 0.59 (**1.38×**) | 2.38 (**5.56×**) |
| lookahead `[a-z]+(?=[a-z])` | 7.53 | 77.17 (**10.25×**) | 6.79 (0.90×) | unsupported |

**arm64** — Apple M1 Pro, Apple clang 16, N = 30 × 3 runs, PCRE2 10.47-JIT, RE2 11.0:

| case | REAL ns/B | std::regex | PCRE2-JIT | RE2 |
| --- | ---: | ---: | ---: | ---: |
| words `[a-z]+` | 1.16 | 92.26 (**79.33×**) | 2.33 (**2.00×**) | 13.97 (**12.01×**) |
| digits `[0-9]+` | 0.84 | 82.13 (**97.20×**) | 1.44 (**1.70×**) | 8.58 (**10.15×**) |
| fields `[^,]+` | 3.25 | 74.28 (**22.88×**) | 1.87 (0.58×) | 10.99 (**3.39×**) |
| alternation `the\|fox\|dog` | 1.93 | 112.84 (**58.50×**) | 1.57 (0.81×) | 6.16 (**3.19×**) |
| date `{4}-{2}-{2}` | 0.49 | 71.55 (**144.84×**) | 0.39 (0.79×) | 3.43 (**6.94×**) |
| hex `[0-9a-f]{8}` | 1.42 | 80.29 (**56.70×**) | 1.25 (0.88×) | 3.42 (**2.42×**) |
| literal | 0.25 | 31.00 (**125.51×**) | 0.48 (**1.94×**) | 1.36 (**5.51×**) |
| lookahead `[a-z]+(?=[a-z])` | 3.81 | 157.14 (**41.23×**) | 3.66 (0.96×) | unsupported |
...
| --- | ---: | ---: | ---: | ---: | --- |
| `\w+` (mixed-script) | 2.295 | 60.18 (26.22×) | 1.86 (**0.81×**) | 3.20 (1.39×) | 16218/5406/16218/5406 ⚠ |
| `\p{L}+` (CJK) | 2.880 | unsupported | 1.33 (**0.46×**) | 13.18 (4.58×) | 12904/—/12904/12904 |
| `\p{N}+` (arabic digits) | 1.876 | unsupported | 1.61 (**0.86×**) | 5.21 (2.78×) | 6250/—/6250/6250 |
| `\p{sc=Han}` (CJK) | 3.326 | unsupported | 2.14 (**0.64×**) | unsupported | 25808/—/25808/— |
| `\p{scx=Cyrl}` (mixed-script) | 2.654 | unsupported | 2.69 (**1.01×**) | unsupported | 32436/—/32436/— |
| `(?i)café` (accented) | 1.276 | unsupported | 0.34 (**0.27×**) | 1.31 (1.03×) | 3509/—/3509/3509 |
| `[à-ÿ]+` (accented) | 1.572 | 86.98 (55.33×) | 2.06 (**1.31×**) | 12.63 (8.03×) | 38599/38599/38599/38599 |
| literal `你好` (CJK) | 0.458 | 29.25 (63.86×) | 0.58 (**1.27×**) | 2.63 (5.74×) | 6452/6452/6452/6452 |
| `.` (emoji, one codepoint) | 4.664 | 59.99 (12.86×) | 3.87 (**0.83×**) | 19.08 (4.09×) | 68306/200039/68306/68306 ⚠ |
| ascii witness `[a-z]+` | 1.163 | 91.60 (78.76×) | 2.26 (**1.94×**) | 13.90 (11.95×) | 42108/42108/42108/42108 |
