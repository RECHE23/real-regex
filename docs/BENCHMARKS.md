...
| Python | CPython 3.14.6, `re` (stdlib) vs the in-place REAL `2026.8.10` extension (§B re-measured for this stamp, arm64 M1 Pro, N = 40 paired samples, bootstrap CI, median of three runs per cell) |
