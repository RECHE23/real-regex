...
both ISAs, on the same `4efdd46` (v2026.8.2) tree for this re-stamp.
...
| case | REAL ns/B | std::regex | PCRE2-JIT | RE2 |
| --- | ---: | ---: | ---: | ---: |
| words `[a-z]+` | 2.22 | 91.43 (**41.20×**) | 2.33 (**1.05×**) | 14.02 (**6.32×**) |
| digits `[0-9]+` | 1.38 | 82.54 (**59.77×**) | 1.44 (**1.04×**) | 8.69 (**6.29×**) |
| fields `[^,]+` | 3.16 | 74.39 (**23.54×**) | 1.87 (0.59×) | 10.98 (**3.47×**) |
| alternation `the\|fox\|dog` | 1.92 | 112.96 (**58.89×**) | 1.57 (0.82×) | 6.16 (**3.21×**) |
| date `{4}-{2}-{2}` | 0.51 | 71.58 (**139.26×**) | 0.39 (0.76×) | 3.41 (**6.63×**) |
| hex `[0-9a-f]{8}` | 1.43 | 80.30 (**56.35×**) | 1.24 (0.87×) | 3.40 (**2.39×**) |
| literal | 0.25 | 30.89 (**125.06×**) | 0.48 (**1.94×**) | 1.36 (**5.51×**) |
| lookahead `[a-z]+(?=[a-z])` | 3.75 | 157.44 (**41.93×**) | 3.66 (0.97×) | unsupported |
...
| --- | ---: | ---: | ---: | ---: | --- |
| `\w+` (mixed-script) | 3.009 | 60.73 (20.18×) | 1.87 (**0.62×**) | 3.20 (1.06×) | 16218/5406/16218/5406 ⚠ |
| `\p{L}+` (CJK) | 4.019 | unsupported | 1.34 (**0.33×**) | 13.30 (3.31×) | 12904/—/12904/12904 |
| `\p{N}+` (arabic digits) | 2.108 | unsupported | 1.60 (**0.76×**) | 5.26 (2.50×) | 6250/—/6250/6250 |
| `\p{sc=Han}` (CJK) | 5.757 | unsupported | 2.14 (**0.37×**) | unsupported | 25808/—/25808/— |
| `\p{scx=Cyrl}` (mixed-script) | 4.179 | unsupported | 2.69 (**0.64×**) | unsupported | 32436/—/32436/— |
| `(?i)café` (accented) | 1.290 | unsupported | 0.34 (**0.26×**) | 1.31 (1.02×) | 3509/—/3509/3509 |
| `[à-ÿ]+` (accented) | 3.390 | 87.38 (25.78×) | 2.06 (**0.61×**) | 12.66 (3.73×) | 38599/38599/38599/38599 |
| literal `你好` (CJK) | 0.457 | 29.10 (63.68×) | 0.58 (**1.27×**) | 2.63 (5.75×) | 6452/6452/6452/6452 |
| `.` (emoji, one codepoint) | 4.368 | 58.90 (13.48×) | 3.84 (**0.88×**) | 18.90 (4.33×) | 68306/200039/68306/68306 ⚠ |
| ascii witness `[a-z]+` | 2.225 | 91.69 (41.21×) | 2.25 (**1.01×**) | 13.90 (6.25×) | 42108/42108/42108/42108 |
