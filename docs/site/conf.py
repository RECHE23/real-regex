...
nitpick_ignore_regex = [
    ...
    # Header comments \ref members of the curated classes; the member refids
    # carry the Doxygen-version-dependent hash, and cross-member refs stay
...
# Our canonical external references, each verified when its entry was framed
# (docs.rs renders the crate's rustdoc, pkg.go.dev the module's godoc, the
# GitHub blobs are this repo itself, sciforge is our own harness repo).
# linkcheck skips exactly these:
